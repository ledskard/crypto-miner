  ...
  .add('Hero Item', () => {
    return (
      <StorefrontHeroItem
        ...
        image="https://app-api.salad.com/api/v/reward-images/b570ab9a-1b83-4abd-a313-41af29680e9d"
        heading={text('heading', 'Discord Nitro Classic')}
        subheading={text('Subheading', '$4.99')}
        buttonLabel={text('Button Label', 'Get It Now')}
        buttonLink="https://app.salad.com/rewards/eebc35f0-4d35-4785-bd3d-d0bd6b2f40e6"
